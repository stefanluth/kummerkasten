  ...
  return (
    <div className="flex flex-col max-w-2xl gap-6 p-2 mx-auto">
      ...
      <FaqItem title="Wie kann ich eine Nachricht teilen?">
        <p>
          Du kannst eine Nachricht teilen, indem du die Nachrichten-ID beginnend mit &apos;#&apos; über der Überschrift
          anklickst und die URL kopierst.
        </p>
      </FaqItem>
      ...
      <FaqItem title="Wie kann ich auf eine Nachricht antworten?">
        <p>
          ...
          implementieren. Bis dahin kannst du die Nachrichten-ID beginnend mit &apos;#&apos; über der Überschrift
